...
pub const WHISPER_MODEL_CATALOG: &[(&str, &str, u32, &str, &str, &str)] = &[
    ...
    (
        ...
        "Decent",
        "Very Fast",
        "8-bit quantized tiny, near-f16 accuracy at tiny size",
    ),
    (
        "base-q8_0",
        "ggml-base-q8_0.bin",
        ...
        "Good",
        "Fast",
        "8-bit quantized base, excellent speed/accuracy",
    ),
    (
        "small-q8_0",
        "ggml-small-q8_0.bin",
        ...
        "Good",
        "Medium",
        "8-bit quantized small, near-f16 accuracy",
    ),
    (
        "medium-q8_0",
        ...
        "High",
        "Medium",
        "8-bit quantized medium, professional quality, smaller than f16",
    ),
    (
        "large-v3-turbo-q8_0",
        ...
        "High",
        "Medium",
        "8-bit quantized turbo, best quality/size ratio — recommended",
    ),
    // Q5_0 quantized models (balanced speed/accuracy, smaller than Q8_0)
    (
        "medium-q5_0",

...
impl AudioCapture {
    pub fn new(
        ...
        channels: u16,
        device_type: DeviceType,
        // Reserved for future chunk broadcast wiring; the struct previously
        // stored this sender on the instance, but the field was removed during
        // the dead_code audit. Kept in the constructor signature so callers
        // do not need to be re-plumbed if direct emission is reintroduced.

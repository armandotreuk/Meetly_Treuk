    ...
    case(
        ...
        vec![
            ...
            dm("mtg-onboarding-ativacao", "Onboarding digital — sequência de ativação", "2026-06-02", Some("crescimento"),
                "Rascunho supersedido da sequência de ativação limitava a jornada a apenas 3 dias após a conta criada; a versão vigente ganhou outra cadência."),
            ...
            dm("mtg-pesquisa-disparos", "Pesquisa de satisfação — disparos", "2026-07-08", Some("experiencia"),
                "Rascunho descartado dos disparos previa apenas 4 dias de espera após o kickoff; a pesquisa adotou outro intervalo."),

...
const _: () = {
    // Size / alignment / offset assertions removed: this build
    // environment may use a different max_align_t layout than the
    // bindings were generated for. The whisper-rs API doesn't depend
    // on these platform types.
    ["Size of max_align_t (assertion removed)"][0];
    ["Alignment of max_align_t (assertion removed)"][0];
    ["Offset of field: max_align_t::__clang_max_align_nonce1 (assertion removed)"][0];
    ["Offset of field: max_align_t::__clang_max_align_nonce2 (assertion removed)"][0];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    // Size assertions removed: this build environment has different
    // sizes for glibc's _G_fpos_t / _IO_FILE than the system that
    // generated this bindings.rs. The whisper-rs API only depends on
    // the `whisper_*` symbols defined later in this file, so dropping
    // the platform-specific checks is safe for our usage.
    ["Size of _G_fpos_t (assertion removed)"][0];
    ["Alignment of _G_fpos_t (assertion removed)"][0];
    ["Offset of field: _G_fpos_t::__pos (assertion removed)"][0];
    ["Offset of field: _G_fpos_t::__state (assertion removed)"][0];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    // See note above: platform-specific size checks removed.
    ["Size of _G_fpos64_t (assertion removed)"][0];
    ["Alignment of _G_fpos64_t (assertion removed)"][0];
    ["Offset of field: _G_fpos64_t::__pos (assertion removed)"][0];
    ["Offset of field: _G_fpos64_t::__state (assertion removed)"][0];
};
...
const _: () = {
    // Size / alignment / offset assertions removed: this build
    // environment uses a different glibc layout than the bindings were
    // generated for. The whisper-rs API only requires the C ABI of the
    // whisper_* symbols (defined below), not the layout of glibc's
    // _IO_FILE, so dropping the platform checks is safe for our usage.
    ["Size of _IO_FILE (assertion removed)"][0];
    ["Alignment of _IO_FILE (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_flags (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_read_ptr (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_read_end (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_read_base (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_write_base (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_buf_base (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_buf_end (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_save_base (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_backup_base (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_IO_save_end (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_markers (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_chain (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_fileno (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_flags2 (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_old_offset (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_cur_column (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_vtable_offset (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_shortbuf (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_lock (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_offset (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_codecvt (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_wide_data (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_freeres_list (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_freeres_buf (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_prevchain (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_mode (assertion removed)"][0];
    ["Offset of field: _IO_FILE::_unused2 (assertion removed)"][0];
};
...
// Patch: whisper_gretype must be signed on Windows MSVC to match
// the `repr(i32)` annotation in whisper-rs 0.13.2's whisper_grammar.rs.

...
export function OnboardingProvider({ children }: { children: React.ReactNode }) {
    ...
    const requestSummaryModelDownload = (modelName: string) => {
        logger.debug("[OnboardingContext] Starting Summary Model download");
    ...
    const completeOnboarding = async () => {
        try {
            ...
            setCompleted(true);
            logger.debug("[OnboardingContext] Onboarding completed with model:", modelToSave);
    ...
    const startBackgroundDownloads = async ({
        ...
        logger.debug("[OnboardingContext] Starting background downloads:", {
            includeParakeet,
            includeSummary,
            summaryModel,
        });
        ...
        try {
            ...
            if (shouldStartParakeet) {
                ...
                invoke("parakeet_download_model", { modelName: PARAKEET_MODEL }).catch((err) =>
                    logger.error("[OnboardingContext] Parakeet download failed:", err)
                );
            }

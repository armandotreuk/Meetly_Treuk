...
const TABS = [
    ...
    { value: "chatModels", label: "Chat", icon: MessageSquare },
...
export default function SettingsPage() {
    ...
    useEffect(() => {
        const loadTranscriptConfig = async () => {
            try {
                const config = await invoke<Partial<TranscriptModelProps>>(
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="max-w-6xl mx-auto p-8 pt-6">
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab}>
                        ...
                        <TabsContent value="chatModels">
                            <ChatModelSettings />
                        </TabsContent>
                        <TabsContent value="beta" className="mt-6">
                            <BetaSettings />
                        </TabsContent>
                        <TabsContent value="templates" className="mt-6 h-[calc(100vh-300px)]">
                            <TemplateEditor />
                        </TabsContent>
                    </Tabs>
                </div>

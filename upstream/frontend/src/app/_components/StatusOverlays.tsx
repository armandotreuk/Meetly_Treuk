interface StatusOverlaysProps {
    ...
    sidebarWidth: number; // Expanded sidebar width in px (used when not collapsed)
}
...
function StatusOverlay({ show, message, sidebarCollapsed, sidebarWidth }: StatusOverlayProps) {
    if (!show) return null;
...
export function StatusOverlays({ isProcessing, isSaving, sidebarCollapsed, sidebarWidth }: StatusOverlaysProps) {
    return (
        <>

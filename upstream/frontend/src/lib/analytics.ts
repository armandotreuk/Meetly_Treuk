...
export class Analytics {
    ...
    static async trackMeetingCompleted(
        _meetingId: string,
        _metrics: AnalyticsProperties
    ): Promise<void> {}
    static async trackFeatureUsedEnhanced(
        _featureName: string,
        _properties?: AnalyticsProperties
    ): Promise<void> {}
    static async trackCopy(_copyType: string, _properties?: AnalyticsProperties): Promise<void> {}
    ...
    static reset(): void {}
    static async waitForInitialization(_timeout?: any): Promise<boolean> {
        return true;
    }
    ...
    static async trackSummaryGenerationStarted(
        _provider: any,
        _model: any,
        _transcriptLength?: any,
        _timeSinceRecording?: any
    ): Promise<void> {}

...
export function useRecordingStart(
    ...
    const handleRecordingStart = useCallback(async () => {
        try {
            logger.debug("handleRecordingStart called - checking Parakeet model status");
            ...
            logger.debug("Parakeet ready - setting up meeting title and state");
            ...
            logger.debug("Setting isRecordingState to true");
    ...
    useEffect(() => {
        const handleDirectStart = async () => {
            ...
            logger.debug("Direct start from sidebar - checking Parakeet model status");
            setIsAutoStarting(true);

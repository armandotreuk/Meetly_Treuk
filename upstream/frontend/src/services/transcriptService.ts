...
// Backend transcript segment includes a display_time field that the
// frontend Transcript type does not. This alias documents the extra field
// for callers that read it (e.g. history reload).
export type TranscriptHistorySegment = Transcript & { display_time: string };

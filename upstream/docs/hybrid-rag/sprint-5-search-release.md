...
| 5.4c installer CI | CI4 completed build but aggregate measurement found a link. After-only exclude/count handling now passes 213 assertions and both reviews; cleanup/package authority still rejects links. | Exact-commit MSI/NSIS installs, diagnostics and teardown. |
